...
deploy_library \
  java/com/google/common/inject/libinject.jar \
  java/com/google/common/inject/libinject-src.jar \
  java/com/google/common/inject/javadoc.jar \
  java/com/google/common/inject/pom.xml
